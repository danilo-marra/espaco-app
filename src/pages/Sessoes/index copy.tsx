...
export function Sessoes() {
  ...
  function calcularRepasse(sessao: Sessao): {
    valorRepasse: number
    ...
    const porcentagemRepasse = dataEntrada <= umAnoAtras ? 0.5 : 0.45

    const valorRepasse =
      sessao.valorSessao * contarDatasValidas(sessao) * porcentagemRepasse

    return { valorRepasse, porcentagemRepasse }
  }
              ...
              <tr key={sessao.id}>
                ...
                <td className="p-4">
                  {dateFormatter.format(
                    new Date(sessao.terapeutaInfo.dtEntrada),
                  )}
                </td>
                ...
                <td className="p-4">
                  {priceFormatter.format(calcularRepasse(sessao).valorRepasse)}{' '}
                  ({calcularRepasse(sessao).porcentagemRepasse * 100})%
                </td>
